...
# STREAMLIT SETTINGS
# ===========================
st.set_page_config(page_title="River Monitor + ML", layout="wide")
...
with col1:
    st.markdown(f"<h1 style='font-size: 48px; text-align: center;'>Water Level<br>{water} cm</h1>", unsafe_allow_html=True)
with col2:
